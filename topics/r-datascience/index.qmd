...
1. [Installing and using R and RStudio](/posts/r-installation/index.qmd).

2. [Operators, Logic & Data Types](/posts/r-operators/index.qmd).

3. [Atomic Data Structures](/posts/r-atomicdata/index.qmd).

4. [Dataframes and Lists](/posts/r-dataframes/index.qmd)

5. Functions

6. Looping and Branching

7. [Fundamentals of Probability Theory](/posts/prob-fundamentals/index.qmd).
