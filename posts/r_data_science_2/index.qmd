...
<div style="display: flex; justify-content: space-between; padding: 20px 0;">
  <!-- Back Button -->
  <a href="/posts/r_data_science_1/index.qmd" style="text-decoration: none; font-size: 18px;">
    &#8592; Previous Chapter
  </a>
  
  <!-- Forward Button -->
  <a href="/posts/r_data_science_3/index.qmd" style="text-decoration: none; font-size: 18px;">
    Next Chapter &#8594;
  </a>
</div>