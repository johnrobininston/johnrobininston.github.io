...
1. [Python AI: How to Build a Neural Network & Make Predictions](https://realpython.com/python-ai-neural-network/) by [Déborah Mesquita](https://github.com/dmesquita) on [Real Python](https://realpython.com).
