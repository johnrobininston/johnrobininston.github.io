...
![Posit website R and RStudio download screen.](img/posit_download.png)
...
![RStudio Layout.](img/rstudio_layout.png)
...
![Set working directory,](img/working_directory.png)
...
![Creating a new R Script.](img/new_script.png)
...
![Saved script appearing in our working directory.](img/saved_script.png)
...
![Package tab with loaded `tidyverse` package.](img/packages.png)
...
![Help function output for `mean()` function.](img/help.png)
