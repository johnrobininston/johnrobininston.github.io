...
image: assets/transition-probabilities-3s.png
toc: true
...
<style>
.chips { display: flex; flex-wrap: wrap; margin: 1.25rem 0; justify-content: space-evenly; }
.chip { display: inline-block; padding: 0.45rem 1.3rem; border-radius: 999px; font-size: 1.1rem; font-weight: 500; line-height: 1.4; margin: 0 1rem; }
.chip-outline { border: 1.5px solid var(--bs-primary, #0d6efd); color: var(--bs-primary, #0d6efd); }
</style>

<div class="chips">
  <span class="chip chip-outline">1. Markovian</span>
  <span class="chip chip-outline">2. Exogenous</span>
  <span class="chip chip-outline">3. Low-cost</span>
  <span class="chip chip-outline">4. Controllable</span>
</div>
...
![HMM Connected Graph.](assets/hmm-diagram.png){width='90%'}
...
![Latent state process transition probabilty diagram.](assets/transition-probabilities-3s.png)
