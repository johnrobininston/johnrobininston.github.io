...
![Example of a CSV file](../assets/images/csv-example.png)
...
cats_data = pd.read_csv("../assets/data/cats.csv")
...
![Wide vs Long Data Structures](../assets/images/long-vs-wide.png)
...
![Tidy Data](../assets/images/tidy-data.png)
