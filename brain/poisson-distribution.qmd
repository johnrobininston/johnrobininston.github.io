...
:::{.definition data-title="Probability Generating Function"}
...
:::{.definition data-title="Moment Generating Function"}
...
:::{.definition data-title="Characteristic Function"}
...
The MGF product gives $e^{\lambda_1(e^t-1)} \cdot e^{\lambda_2(e^t-1)} = e^{(\lambda_1+\lambda_2)(e^t-1)}$.
